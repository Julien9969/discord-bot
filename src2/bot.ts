...
import { Client, Events, Guild, IntentsBitField } from 'discord.js';
...
async function registerSlashCommands(guildo: Guild | undefined) {
	try {
		if (!guildo) return console.log('No guild found.');
		...
		if (!guildId) return console.log('No guild ID found.');
...
client.on('interactionCreate', async (interaction) => {
	...
	if (commandName === 'hello') {
		...
		await interaction.reply('TODO: server infos !!');
	}
